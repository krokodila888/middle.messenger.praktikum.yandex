export const phonePattern = /^\+{0,1}\d{10,15}$/;
export const loginPattern = /^[A-Za-z0-9\-_]+$/;
export const anyLatinLetterPattern = /[A-Za-z]/;
export const anyBigLetterPattern = /[A-ZА-ЯЁ]/;
export const anyDigitPattern = /\d/;
